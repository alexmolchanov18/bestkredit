...
$ar = new Autorotator(2, array(1272, 1704, 250, 1986, 1436, 1844, 1711, 1411));
?>
<!DOCTYPE html>
<html lang="ru">
...
<script>
  ...
  OneSignal.push(function() {
    ...
    <body>
        <input id="domain" style="display: none;" type="text" value="bestkreditGdn">
        ...
        <div class="wrapper">
            <header class="page-header" id="headers">
                <div class="container">
                    <!--<a href="https://go.salesdoubler.net/in/offer/1261?aid=63223" style="text-decoration: none;"> <img src="banner.png" alt="banner"></a>-->
            ...
            <main>
                <div class="container c">
                    ...
                    <div class="banks">
                        <a href="https://go.salesdoubler.net/in/offer/1712?aid=63223" target="_blank" class="bank <?php $ar->displayHideClass(1712); ?>" style="cursor: pointer;">
                            <div class="bank-img"><img id="bystro" src="/images/dinero.png" alt="bystro"></div>
                            ...
                            <div class="bank-link">Получить займ</div>
                        </a>
                        <a href="https://go.salesdoubler.net/in/offer/1712?aid=63223" target="_blank" class="bank <?php $ar->displayHideClass(1712); ?>" style="cursor: pointer;">
                            <div class="bank-img"><img id="bystro" src="/images/ukrpozika.png" alt="bystro"></div>
                            <div class="bank-features">
                                <b>Под 0 процентов!</b>
                            </div>
                            <table class="bank-properties">
                        ...
                        <a href="https://go.salesdoubler.net/in/offer/1272?aid=63223" target="_blank" class="bank <?php $ar->displayHideClass(1272); ?>" style="cursor: pointer;">
                            <div class="bank-img"><img id="bystro" src="/images/schvidko.jpeg" alt="bystro"></div>
                            <div class="bank-features">
                                <b>Под 0 процентов!</b>
                            </div>
                            <table class="bank-properties">
                        ...
                        <a href="https://go.salesdoubler.net/in/offer/1436?aid=63223" target="_blank" class="bank <?php $ar->displayHideClass(1436); ?>" style="cursor: pointer;">
                            <div class="bank-img"><img id="bystro" src="/images/miloan.jpg" alt="bystro"></div>
                            <div class="bank-features">
                                <b>Под 0 процентов!</b>
                            </div>
                            <table class="bank-properties">
                         ...
                         <a href="https://go.salesdoubler.net/in/offer/1704?aid=63223" target="_blank" class="bank <?php $ar->displayHideClass(1704); ?>" style="cursor: pointer;">
                            <div class="bank-img"><img id="bystro" src="/images/creditkasa.jpg" alt="bystro"></div>
                            <div class="bank-features">
                                <b>Под 0 процентов!</b>
                            </div>
                            <table class="bank-properties">
                        ...
                        <!-- <a href="https://go.salesdoubler.net/in/offer/250?aid=63223" target="_blank" class="bank" style="cursor: pointer;">
                            <div class="bank-img"><img id="bystro" src="/images/moneyveo.png" alt="bystro"></div>
                            <div class="bank-features">
                                <b>Под 0 процентов!</b>
                            </div>
                            <table class="bank-properties">
                       ...
                       <!--  <a href="https://go.salesdoubler.net/in/offer/1711?aid=63223" target="_blank" class="bank" style="cursor: pointer;">
                            <div class="bank-img"><img id="bystro" src="/images/e-groshi.png" alt="bystro"></div>
                            <div class="bank-features">
                                <b>Под 0 процентов!</b>
                            </div>
                            <table class="bank-properties">
                        ...
                        <a href="https://go.salesdoubler.net/in/offer/1411?aid=63223" target="_blank" class="bank <?php $ar->displayHideClass(1411); ?>" style="cursor: pointer;">
                            <div class="bank-img"><img id="bystro" src="/images/vasha.png" alt="bystro"></div>
                            <div class="bank-features">
                                <b>Под 0 процентов!</b>
                            </div>
                            <table class="bank-properties">
                       ...
                       <!--  <a href="https://go.salesdoubler.net/in/offer/1272?aid=63223" target="_blank" class="bank" style="cursor: pointer;">
                            <div class="bank-img"><img id="bystro" src="/images/schvidko.jpeg" alt="bystro"></div>
                            <div class="bank-features">
                                <b>Под 0 процентов!</b>
                            </div>
        ...
        <script src="/href_replacer.js"></script>
        <script>
