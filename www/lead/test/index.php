...
})(window,document,'script','dataLayer','GTM-P2XCJ66');</script>
<!-- End Google Tag Manager -->
    ...
    <title>Возьми кредит под 0% за 8 минут - Zaim-online.site</title>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P2XCJ66"
            ...
            <div class="block-form">
                ...
                <div class="form">
                  ...
                  <form action="order.php" method="post" target="votar" name="contact">
                    <input type="text" name="name" required placeholder="Ваше имя" required>&ensp;
                    <input type="text" name="phone" id="phone" placeholder="Ваш телефон" required >&ensp;
                    <input type="hidden" name="access-token" value="0e419d1547d5094a6f702c1daec1a893">
...
<!--             <div class="animate-number full-width">
  ...
  <ul class='carousel is-set'>
    <li class='carousel-seat'>
      <p>Саша, м. Дубно</p>Позичав гроші в кількох компаніях і випадково знайшов Zaim-online.site. На подив все виявилось швидше, легше, з меншими відсотками порівняно з іншими. Наразі буду користуватись ними.
    </li>
    <li class='carousel-seat'>
...
Cashup.com.ua - при взятии в долг 1000 грн. на 3 месяцев, комиссия 1061.70 грн., общие затраты на займ составляют 2061.70 грн., APR 547.5%.<br>
                ...
                <p>Контакты кредитных компаний<br>
...
Наш адрес. Киев, ул. Лебедева-Кумача 7В, тел. 0-800-50-10-30 </p>
                
                
                <p>Zaim-online.site - это платформа, предлагающая клиенту предложения кредитных организаций. Мы не являемся финансовой организацией, банком или кредитором. Подсчеты носят приблизительный характер, окончательные условия уточняйте на сайте кредитной компании. </p>
                               
            </div>
            <div class="footerUpfinance">
                <p>© 2018. Zaim-online.site. Все права защищены</p>
            </div>
        </footer>
        </div>
    </div>
