<?php
class SalesDoublerAPI
{
    const REMOTE_DOMAIN = "http://api.admin.salesdoubler.net";//
    const REMOTE_PATH_LEAD   = "/leads/fajnagotivka/";
    const ACCESS_TOKEN_LEAD = "eNpt21FjsAcYi13hzGqxkvN2yCs-F4Cx";
